    ...
    <div className="animate-fade-in">
      <div className="glass-card" style={{ padding: '24px', marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '13px', marginTop: '4px' }}>
          Real-time feed of examinations results declared by Dayalbagh Educational Institute.
        </p>
      ...
      {loading ? (
        ...
        <div className="glass-card" style={{ textAlign: 'center', padding: '48px 20px', color: 'var(--text-secondary)' }}>
          ...
          <p style={{ fontSize: '13px', maxWidth: '300px', margin: '0 auto' }}>
            No result links matched your search term. Try checking spelling or search a broader term like "PV" or "Remedial".
          </p>
        </div>
      ) : (
          ...
          {filteredResults.map((res, idx) => (
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1, paddingRight: '16px' }}>
                <span style={{ fontSize: '13.5px', fontWeight: '500', color: 'var(--text-primary)', lineHeight: '1.4' }}>
                  {res.title}
                </span>
                <span style={{ fontSize: '10.5px', color: 'var(--text-secondary)', fontFamily: 'monospace' }}>
                  dei.ac.in • Official Notification
                </span>
              </div>
              <svg style={{ width: '16px', height: '16px', color: 'var(--text-secondary)', flexShrink: 0 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
